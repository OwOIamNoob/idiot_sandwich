...
class DlibLitModule(LightningModule):
    ...
    def model_step(self, batch: Any):
        ...
        # self.trainer.logger.experiment.log({"samples", 
        #                             [wandb.Image(img)
        #                                 for img in TransformDataset.annotate_tensor(torch.Tensor.cpu(x), 
        #                                                                             torch.Tensor.cpu(preds))]})
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        self.log("train/mae", self.train_mae, on_step=True,
    ...
    def traning_epoch_end(self, outputs: List[Any]):
